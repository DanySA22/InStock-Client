      ...
      <div className="ware-house-list-selection">
        <div className="ware-house-list-selection__container">
          <div className="ware-house-list-selection__subcontainer">
            ...
            <button className="ware-house-list-selection__button" onClick={detailsButtonClick}>
        ...
        <div className="ware-house-list-selection__action">
          <button className="ware-house-list-selection__delete" onClick={togglePopup}>
            d
          </button>
          <NavLink className="ware-house-list-selection__link" to={`/editWareHouse/${warehouse.id}`}>
