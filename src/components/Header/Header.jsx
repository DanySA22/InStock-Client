      ...
      <div className="header__border">
        ...
        <div className="header__actions">
          <div className="header__warehouse">
            <NavLink to="/">
              <button className={`header__button ${activeButton === "warehouse" ? "header__button--active" : ""}`} onClick={() => setActiveButton("warehouse")}>
                Warehouse
              </button>
            </NavLink>
          </div>
          <div className="header__inventory">
            <NavLink to="/inventory">
              <button className={`header__button ${activeButton === "inventory" ? "header__button--active" : ""}`} onClick={() => setActiveButton("inventory")}>
                Inventory
              </button>
            </NavLink>
          </div>
