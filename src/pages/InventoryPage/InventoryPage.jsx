    ...
    <div className="inventory-list-selection" key={inventory.id}>
      ...
      <div className="inventory-list-selection__container inventory-list-selection__container--qty">
        ...
        <div className="inventory-list-selection__action">
          <button className="inventory-list-selection__delete" onClick={() => handleDeleteButtonClicked(inventory)}>
            d
          </button>
    ...
    <div className="warehousepage">
      ...
      <DeleteWareHousePopup isOpen={isPopupOpen} onClose={togglePopup}>
        <div className="ware-house-list-selection__popup">
          <h1 className="ware-house-list-selection__header">Delete {selectedItem.item_name} warehouse?</h1>
          <p className="ware-house-list-selection__text"> Please confirm that you'd like to delete the {selectedItem.item_name} warehouse from the list of warehouses. you won't be able to undo this action</p>
